...
<x-layout class="test"> 
    ...
    <x-card class="login_form">
        <header class="text-center">
        </header>

        <form class="form_canvas" method="POST" action="/users/authenticate">
            <p class="welcome">
                Login to RemoteKnock
            ...
            <div class="flex-row">
              ...
              {{-- <span class="span" style="color: #8a8a8a">Forgot Password? Click here to <a href="{{ route('forget.password.get') }}" class=" hover:underline" style="color: #2d79f3;
                ;">Reset Password</a></span> --}}

                <p class="p" style="color: #8a8a8a">Forgot Password? Click here to <a href="{{ route('forget.password.get') }}"   style="color: #2d79f3;
                  ;">Reset Password</a>
            </div>
            ...
            <p class="p">Don't have an account?<a href="/register"> </a>  <a href="/register" class="span">Sign Up</a>
